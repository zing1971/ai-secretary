...
7. "Proactive_Process" — 要求你主動分析、整理、處理事務（今日總結報告）
   ✅ 「📂 今日簡報」「今日簡報」「請給我一份今日綜合簡報」「今天有什麼需要我注意的」
   ❌ 不含單純查詢特定行程或雲端硬碟整理。

8. "Query_Tasks" — 查詢 Google Tasks 上的待辦事項清單
   ✅ 「✅ 待辦清單」「我有哪些待辦事項」「顯示我的 Tasks」「有哪些沒做的事」

9. "Visual_Assistant" — 視覺助理按鈕觸發（引導上傳）
   ✅ 「📸 視覺助理」

10. "Chat" — 以上皆非（一般對話、閒聊、打招呼、感謝、詢問已知偏好、查詢記憶核心等）
   ✅ 「🧠 記憶核心」「你是誰」「回報我的個人偏好」「你好」「謝謝」「今天天氣好嗎」
