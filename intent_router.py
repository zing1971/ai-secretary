...
7. "Organize_Drive" — 要求整理雲端硬碟。
   - 觸發條件：明確提到「整理雲端、整理硬碟、整理 Drive」。

8. "Organize_Contacts" — 整理 Google 聯絡人，自動幫未分類聯絡人貼標籤。
   - 觸發條件：提到「整理聯絡人、整理通訊錄、聯絡人分類、幫聯絡人貼標籤」。

10. "Proactive_Process" — 今日綜合簡報。

11. "Search_Web" — 詢問即時性資訊。
   - 觸發條件：需要最新的外部資訊（天氣、股價、新聞、即時事件）。
   - 必須輸出 `search_keyword`。

12. "Visual_Assistant" — 處理圖片內容（名片、海報、會議筆記）。
   - 觸發條件：用戶提到要「傳照片、傳圖片、辨識訊息」或要求辨識圖片中內容。

13. "Chat" — 純粹的問候閒聊（早安、感謝、問好）。
